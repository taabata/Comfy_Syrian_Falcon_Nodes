    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "font": (os.listdir("/usr/share/fonts/truetype/freefont/"),),
                "rotate": ("INT", {
                    "default": 0,
                    "min": 0,
                    "max": 360,
...
class KSamplerAdvancedCustom:
    ...
    CATEGORY = "SyrianFalcon/nodes"
    def sample(self, clip,model, add_noise, noise_seed, steps, cfg, sampler_name, scheduler, positive, negative, latent_image, start_at_step, end_at_step, text, return_with_leftover_noise, denoise=1.0):
